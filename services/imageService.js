...
export const getUserImageSrc = imagePath => {
  if (!imagePath) {
    return require('../assets/images/defaultUser.png');  // Default fallback image
  }
  
  // If the imagePath is a local file (file://), return it directly
  if (imagePath.startsWith('file://')) {
    return { uri: imagePath };
  }

  // Otherwise, it's an image from Supabase (remote path)
